window.onload = function() {
    ...
    const lenis = new Lenis({
        duration: 1, // 지속 시간
        lerp: 0.5, // 부드러움
        wheelMultiplier: 0.5, // 마우스 휠 민감도 
        touchMultiplier: 1.7, // 터치 스크롤 민감도
        smoothWheel: false,
        smoothTouch: true
    });
...
setTimeout(() => {
    ...
    ScrollTrigger.matchMedia({                    
        ...
        "(max-width: 1024px)": function() {
            ...
            horiani.addLabel('a')                            
            horiani.fromTo(".page_horizontalInner2", { y:0 }, { y:0, duration:10, delay: 1, ease: "power4.inOut",},'a');

            horiani.addLabel('a')                            
            horiani.fromTo(".page_horizontalInner2", { y:0 }, { y:"-33.33%", duration:10, delay: 1, ease: "power4.inOut",},'a');
            horiani.fromTo(".zero", { y:0 }, { y:"-22rem", duration:10, ease: "power4.inOut",},'a');
            horiani.fromTo(".star", { y:0 }, { y:"-7rem", duration:10, ease: "power4.inOut",},'a');
            horiani.fromTo(".cloud", { y:0 }, { y:"-22rem", duration:10, ease: "power4.inOut",},'a');
            horiani.fromTo(".spring", { y:0 }, { y:"-7rem", duration:10, ease: "power4.inOut",},'a');

            horiani.fromTo(".spring2", { y: "22rem" }, { y:0, duration:10, delay: 1,  ease: "power4.inOut",},'a');
            horiani.fromTo(".star2", { y: "7rem" }, { y:0, duration:10, delay: 1, ease: "power4.inOut",},'a');
            horiani.fromTo(".bag", { y: "8rem" }, { y:0, duration:10, delay: 1, ease: "power4.inOut",},'a');
            horiani.fromTo(".sun", { y: "22rem" }, { y:0, duration:10, delay: 1, ease: "power4.inOut",},'a');

            horiani.addLabel('b')                            
            horiani.fromTo(".page_horizontalInner2", { y: "-33.33%" }, { y:"-33.33%", duration:10, delay: 1, ease: "power4.inOut",},'b');

            horiani.addLabel('b')                            
            horiani.fromTo(".page_horizontalInner2", { y: "-33.33%" }, { y:"-66.66%", duration:10, delay: 1, ease: "power4.inOut",},'b');
            horiani.fromTo(".spring2", { y:0 }, { y:"-22rem", duration:10, ease: "power4.inOut",},'b');
            horiani.fromTo(".star2", { y:0 }, { y:"-7rem", duration:10, ease: "power4.inOut",},'b');
            horiani.fromTo(".bag", { y:0 }, { y:"-22rem", duration:10, ease: "power4.inOut",},'b');
            horiani.fromTo(".sun", { y:0 }, { y:"-8rem", duration:10, ease: "power4.inOut",},'b');

            horiani.fromTo(".spring3", { y: "22rem" }, { y:0, duration:10, delay: 1,  ease: "power4.inOut",},'b');
            horiani.fromTo(".mango", { y: "22rem" }, { y:0, duration:10, delay: 1, ease: "power4.inOut",},'b');
            horiani.fromTo(".smile", { y: "22rem" }, { y:0, duration:10, delay: 1, ease: "power4.inOut",},'b');

            horiani.addLabel('c')                            
            horiani.fromTo(".page_horizontalInner2", { y: "-66.66%" }, { y:"-66.66%", duration:10, delay: 5, ease: "power4.inOut",},'c');

            horiani.addLabel('pause', '+=1'); // 1초 대기
