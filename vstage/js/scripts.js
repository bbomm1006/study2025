...
---------------------------------------------------*/
	...
	function CustomFunction() {
		...
		$('.search-icon').on('click', function() {
				...
				$('nav').addClass('hidden');
				$('header .button-wrap').addClass('hidden');
		...
		$('.search-close').on('click', function() {
				...
				$('header .button-wrap').removeClass('hidden');
		});
		...
		$('.popup').on('click', function() {
				$('.view-privacy').addClass('show');
				$('.close-privacy').addClass('show');
		});
			
		$('.close-privacy').on('click', function() {
				$('.view-privacy').removeClass('show');
				$('.close-privacy').removeClass('show');
		});
		$('.closeBTN1').on('click', function() {
				$('.view-privacy').removeClass('show');
				$('.close-privacy').removeClass('show');
		});
		$('.four-grid').on('click', function() {
				$('.portfolio').addClass('all3d');
				$('.two-grid').addClass('opacity');
				$('.four-grid').removeClass('opacity');
		});
		$('.two-grid').on('click', function() {
				$('.portfolio').removeClass('all3d');
				$('.four-grid').addClass('opacity');
				$('.two-grid').removeClass('opacity');
		});
			...
			if($(".item:hidden").length == 0) {
	  		...
	  		$("#loadMore").on("click", function(e){
	  			e.preventDefault();
	    	$(".item:hidden").slice(0, 15).slideDown();
	    	if($(".item:hidden").length == 0) {
			$("#loadMore").text("There are no more asset").addClass("noContent");
...
---------------------------------------------------*/
	...
	function PageLoad() {
		...
		gsap.to($("#header-container"), {duration: 0.1, opacity:1, delay:0, ease:Power2.easeOut}); 
		...
		function initOnFirstLoad() {
			...
			$('body').waitForImages({
				finished: function() {
					...
					gsap.to($(".preloader-intro"), {duration: 0.1, fopacity:1, y:-400, delay:0, ease:Power2.easeInOut});						
					gsap.to($(".preloader-wrap"), {duration: 0.1, yPercent: -101, delay:0, ease:Power2.easeInOut});
					gsap.set($(".preloader-wrap"), {visibility:'hidden', delay:0, opacity:0});					
					setTimeout(function(){
						$('body').waitForImages({
							finished: function() {
								gsap.to($(".header-middle, #footer-container, .showcase-counter, .swiper-pagination-bullet-active .counter"), {duration: 0.1, opacity:1, delay:0, ease:Power2.easeOut}); 										
							},
							waitForAll: false
						});
						...
						gsap.to($(".button-box"), {duration: 0.2, opacity:1, delay:0.7, ease:Power2.easeOut});
						if( $('#hero').hasClass("has-image")) {								
							...
							gsap.to($("#hero-bg-image"), {duration: 1, force3D:true, scale:1 , opacity:1, delay:0, ease:Power2.easeOut});							
							gsap.to($(".hero-arrow"), {duration: 0.5, force3D:true, y:-60, opacity:1, delay:0, ease:Power2.easeOut});
							...
							gsap.to($(".hero-footer-left, .hero-footer-right"), {duration: 1, force3D:true, y:0, opacity:1, rotation:0, delay:0, ease:Power2.easeOut});																				
							gsap.to($("#main-page-content, #page-nav"), {duration: 0.1, opacity:1, delay:0, ease:Power2.easeOut});
						} else {
							gsap.to($(".hero-arrow"), {duration: 0.5, force3D:true, y:-60, opacity:1, delay:0, ease:Power2.easeOut});							
							gsap.set($("#hero .hero-subtitle span"), {y: 60, opacity:0});					
							gsap.to($("#hero .hero-subtitle span"), {duration: 0.7, y: 0, opacity:1, stagger:0.1, delay:0, ease:Power3.easeOut});			
							gsap.to($("#hero-caption .hero-title span"), {y: 120, opacity:0});					
							gsap.to($("#hero-caption .hero-title span"), {duration: 1, y: 0, opacity:1, stagger:0.1, delay:0, ease:Power3.easeOut});
							gsap.to($(".hero-footer-left, .hero-footer-right"), {duration: 0.7, force3D:true, y:0, opacity:1, rotation:0, delay:0, ease:Power2.easeOut});									
							gsap.to($("#main-page-content, #page-nav"), {duration: 0.1, opacity:1, delay:0, ease:Power2.easeOut});
							gsap.to($(".error-button"), {duration: 0.4, y: 0, opacity:1, rotation:0, delay:0, ease:Power2.easeOut});				
						}	
						...
						if( !$('#canvas-slider').hasClass("active")) {	
							...
							gsap.to($('#canvas-slider'), {duration: 0.7, opacity:1, scale:1, delay:0, ease:Power2.easeOut});
						}
						...
						gsap.to($(".showcase-pagination"), {duration: 0.3, opacity:1, delay:0, ease:Power2.easeOut});
						...
						gsap.to($("#showcase-carousel-holder"), {duration: 0.7, opacity:1, delay:0, ease:Power2.easeOut});
						...
						gsap.to($("#showcase-carousel-holder .swiper-slide-active").nextAll(), {duration: 0.7, x:0, scale:1, delay:0, stagger:0.1, opacity:1, ease:Power2.easeOut});
						
						
						
						gsap.set($(".swiper-prev, .swiper-next, .swiper-pagination-bullet"), {opacity:0});	
						gsap.to($(".swiper-prev, .swiper-next, .swiper-pagination-bullet"), {duration: 0.3, y:0, opacity:1, rotation:0, delay:0, ease:Power2.easeOut});
						...
						$(".slide-small-title span").each(function(index, element) {
							tlSmallTitles.to(element, {duration: 0.5, force3D:true, y:0, opacity:1, delay:0, ease:Power2.easeOut}, index * 0.05)
						});
						...
						$(".sl-title span, .split-title span").each(function(index, element) {
							SlideListTitle.to(element, {duration: 0.7, force3D:true, y:0, opacity:1, delay:0, ease:Power2.easeOut}, index * 0.05)
						});
						
						var SlideListSubtitle = gsap.timeline();					
						$(".sl-subtitle span, .split-subtitle span").each(function(index, element) {
							SlideListSubtitle.to(element, {duration: 0.7, force3D:true, y:0, opacity:1, delay:0, ease:Power2.easeOut}, index * 0.05)
						});
		...
		if( $('.snap-slider-holder').length > 0 ){
			...
			if (!$("body").hasClass("disable-ajaxload")) {
				$('.snap-slider-holder .slide-title').on('click', function() {
					...
					gsap.to('.slide-title span', {duration: 1, y:-120, opacity:0, stagger: 0.02, ease:Power2.easeInOut});
